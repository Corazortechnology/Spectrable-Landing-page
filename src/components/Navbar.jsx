...
const Navbar = () => {
    ...
    return (
        <nav className="w-full flex items-center justify-between px-6 py-2 bg-white shadow-sm fixed">

            <Link to="/">
                <div className="flex items-center space-x-2">
                    <img className="h-[80px]" src="/images/logo1.png" alt="logo spectrable" />
                </div>
            </Link>

            <div className="hidden md:flex font-semibold items-center space-x-16 text-[20px] text-black">
            ...
            <div className="hidden md:flex"><button className="bg-[#3883F5] text-white px-5 py-2 rounded-full text-[18px] hover:opacity-90 transition">
