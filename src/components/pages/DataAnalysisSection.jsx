    ...
    return (
        <>
            <section className="px-6 md:px-16 py-16 bg-white space-y-16">
                ...
                <div className="flex flex-col h-[300px] md:flex-row items-center justify-between gap-8 mb-8">

                    <div className="w-full md:w-1/2 flex justify-center">
                        <img
                            src="/images/analysis.jpg"
                            alt="AI Analysis Illustration"
                            className="max-w-[280px] h-[380px] md:max-w-[350px] w-full border-6 border-black rounded-2xl shadow-sm"
                        />
                    </div>
